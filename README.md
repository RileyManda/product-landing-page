...
**[Portfolio-website]** Product Landing Page Microverse trial project that displays a list of product and description of those products.
...
Creating your first "Product Landing Page" project
...
- [ ] **[Header Section]**
      Header section: This section will be itirated to improve the website and make the header more responsive.

- [ ] **[Video header Section]**
      This section needs some improvements.The video will be centered to the view and be responsive.

- [ ] **[About Section]**
      Typography semantics will be applied to improve the layout of the content in the section.

- [ ] **[Download Section]**
      Download section background will be updated and card added with background images of the various games to download and their links.
